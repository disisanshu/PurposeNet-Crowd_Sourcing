...
if(isset($_POST["tab"])){	unset($_SESSION["defaultTab"]);	$defaultTab= $_POST["tab"]; echo "trying= ".$defaultTab;}
else if(isset($_SESSION["defaultTab"])){	$defaultTab= $_SESSION["defaultTab"]; echo "value= ".$defaultTab;}
