...
//$addRelation = $_POST["addRelation"];
$submitRelation = $_POST["submitRelation"];
$addPurpose = $_POST["addPurposeComp"];
$submitPurpose = $_POST["submitPurposeComp"];
$change= $_POST["change"];
//
...
if(isset($_SESSION["defaultTab"])){ $defaultTab= $_SESSION["defaultTab"]; }//unset($_SESSION["defaultTab"]; }
//else { $defaultTab= "component"; $_SESSION["defaultTab"]= $defaultTab; }
//

$mainRel = $_SESSION["ma"];
$resultRel = mysql_query("SELECT * FROM `temp` WHERE main='$main' AND count<=10 ORDER BY count DESC LIMIT 7");
$art = array();
$i=0;
...
$len = $i;
if($_SESSION["i"]+1 && $defaultTab != "purpose")
{
	$i = $_SESSION["i"];
	if($i == $len)
	{
...
// CODE for 'submit' button for all the TABs; i.e., add option for all the TABs
if($addComponent == "Submit")
{
	$flagComp = 0;
	//$defaultTab= "component";
	//$_SESSION["defaultTab"]= $defaultTab;
...
/*if ($addRelation == "Submit")
{

}*/
else if ($addPurpose == "Submit")
{
	$flagPurpose=0;
...
// CODE for 'submit' button of each TABs
...
// CODE for 'change' Artifact button for all the TABs
...
// Default when the page will be loaded
else
{
	$defaultTab= "component";
	$_SESSION["defaultTab"] = $defaultTab;
